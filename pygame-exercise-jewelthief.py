...
def start():
    ...
    while not done:
        ...
        #creat a surface for the score and lives
        score_image = font.render(f"Score: {score}", True, BLACK)
        lives_image = font.render(f"Lives: {int(player.lives)}", True, (0,250,0) )

        all_sprites.draw(screen)
       
        # blit ths urface on the screen
        screen.blit(score_image, (5,5))
        screen.blit(lives_image, (5,40))
